      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td>
              <select id="wd-group" defaultValue={assignment.group || "ASSIGNMENTS"}>
          ...
          <tr>
            ...
            <td>
              <select id="wd-display-grade-as" defaultValue={assignment.displayGradeAs || "Percentage"}>
          ...
          <tr>
            ...
            <td>
              <select id="wd-submission-type" defaultValue={assignment.submissionType || "Online"}>
